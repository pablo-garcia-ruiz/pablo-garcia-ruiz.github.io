...
print('\n' * 110)
print('================================')
print('DROIDS 2 - by Pablo - type help')
print('================================')
...
Exercise caution this Droid is extremely powerful and
...
MEECDT1000 droid are priceless.You are now
destined for prosperity. Production of
these Droids will Commence at once.''')
	time.sleep(1)
	print('\n - ACHIEVED END OF GAME WITH STATUS = WIN -\n')
	exit(0)
